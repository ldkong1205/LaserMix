...
## Acknowledgement
We acknowledge the use of the following public resources during the course of this work: <sup>1</sup>[nuScenes](https://www.nuscenes.org), <sup>2</sup>nuScenes-devkit, <sup>3</sup>[SemanticKITTI](http://www.semantic-kitti.org/), <sup>4</sup>SemanticKITTI-API, <sup>5</sup>[ScribbleKITTI](https://github.com/ouenal/scribblekitti), <sup>6</sup>FIDNet, <sup>7</sup>Cylinder3D, <sup>8</sup>TorchSemiSeg, <sup>9</sup>MixUp, <sup>10</sup>CutMix, <sup>11</sup>CutMix-Seg, <sup>12</sup>CBST, <sup>13</sup>MeanTeacher, and <sup>14</sup>Cityscapes.

We would like to thank <a href="https://scholar.google.com/citations?user=mhaiL5MAAAAJ" target='_blank'>Fangzhou Hong</a> for insightfull discussions and feedback.
